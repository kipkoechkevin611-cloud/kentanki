            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+2540785398094" className="text-white hover:text-orange-500 transition-colors text-sm">
                    +254 785 398 094
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="https://wa.me/2540785398094" target="_blank" rel="noopener noreferrer" className="text-white hover:text-orange-500 transition-colors text-sm">
                    +254 785 398 094
                  </a>
                </div>
              </div>
