            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+254736010873" className="text-white hover:text-orange-500 transition-colors text-sm">
                    +254 736 010 873
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="https://wa.me/254736010873" target="_blank" rel="noopener noreferrer" className="text-white hover:text-orange-500 transition-colors text-sm">
                    +254 736 010 873
                  </a>
                </div>
              </div>
