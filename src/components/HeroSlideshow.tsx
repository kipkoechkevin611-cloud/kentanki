                ...
                <div className="container mx-auto px-4">
                  ...
                  >
                    ...
                    >
                      ...
                      <a href="https://wa.me/2540106795373" target="_blank" rel="noopener noreferrer">
                        <motion.button
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                        ...
                        <a href="tel:+2540106795373" className="text-lg font-bold text-white hover:text-orange-400 transition-colors">
                          +254 010 679 5373
                        </a>
                      </div>
                    </motion.div>
