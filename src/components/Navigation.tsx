    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <button
            className="md:hidden text-white focus:outline-none focus:ring-2 focus:ring-orange-500 rounded p-2"
            ...
            <div className="container mx-auto px-4 py-4">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="block py-3 text-white hover:text-orange-500 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-orange-500 rounded px-2"
              ...
              <div className="flex flex-col gap-3 mt-4" role="none">
                <Button variant="outline" size="sm" className="border-white text-white hover:bg-white hover:text-navy-900" aria-label="Call us">
                  <Phone className="w-4 h-4" />
                  Call Us
                </Button>
                <button
